...
const Footer: React.FC = () => {
  return (
    <footer className="py-16 section-padding bg-neutral-100 dark:bg-neutral-900 text-neutral-900 dark:text-white transition-colors">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
            ...
            >
              ...
              <span>illedragos@yahoo.com</span>
            </a>

            <a
              href="https://www.linkedin.com/in/dragos-ille-374a46213/"
              target="_blank"
